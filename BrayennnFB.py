...
for xd in range(10000):
	...
	uaku=f'Mozilla/5.0 (Linux; Android {a}; POCOPHONE F2) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
	ugen2.append(uaku)

for t in range(10000):
	rr = random.randint
	samsung=random.choice(['M1805E10A','POCOPHONE F1','POCO F1'])
	android=random.choice(['10','9','8'])
	build=random.choice(['QKQ1.190828.002'])
	browser=random.choice(['Chrome/112.0.0.0','HeyTapBrowser/10.8.12.2','HeyTapBrowser/45.9.3.1.1','HeyTapBrowser/40.8.12.2','HeyTapBrowser/10.7.10.0.2','HeyTapBrowser/10.8.9.1','HeyTapBrowser/26.7.36.1','HeyTapBrowser/12.7.36.1','HeyTapBrowser/8.7.36.1','HeyTapBrowser/30.7.36.1','HeyTapBrowser/18.7.36.1','HeyTapBrowser/23.7.36.1'])
	...
	brayen2=f'Mozilla/5.0 (Linux; Android {android}; K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 {browser}'
	...
	try:
		...
		with requests.Session() as r:
			try:
				...
				r.headers.update({'sec-fetch-mode': 'navigate','user-agent': 'Mozilla/5.0 (Linux; Android 10; POCOPHONE F1 Build/QKQ1.190828.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/112.0.0.0 Mobile Safari/537.36','sec-fetch-site': 'cross-site','Host': 'm.facebook.com','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','sec-fetch-dest': 'document',})
